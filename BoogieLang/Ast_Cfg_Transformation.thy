...
type_synonym ('a, 'm) satisfies_spec_func_type = 
  "mbodyCFG proc_context \<Rightarrow> var_context \<Rightarrow> ('a, 'm) fun_interp \<Rightarrow> rtype_env \<Rightarrow> expr list \<Rightarrow> expr list \<Rightarrow> ast \<Rightarrow> ('a, 'm) nstate \<Rightarrow> bool"
...
lemma not_true_equals_false:
  ...
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>expr, ns1\<rangle> \<Down> BoolV (False)"  
  using assms
proof cases
  case (RedUnOp v)
  ...
  from this RedUnOp have 
    expand1: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>expr,ns1\<rangle> \<Down> (LitV (LBool b1))" and 
...
lemma not_false_equals_true:
  assumes "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>UnOp unop.Not expr, ns1\<rangle> \<Down> BoolV False"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>expr, ns1\<rangle> \<Down> BoolV (True)"  
  using assms
proof cases
  case (RedUnOp v)
  from this obtain b1 where "v = LitV (LBool b1)"
...
lemma true_equals_not_false:
  assumes "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>expr, ns1\<rangle> \<Down> BoolV True"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>UnOp unop.Not expr, ns1\<rangle> \<Down> BoolV (False)"
  using assms by (auto intro: RedUnOp)

lemma false_equals_not_true:
  assumes "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>expr, ns1\<rangle> \<Down> BoolV False"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>UnOp unop.Not expr, ns1\<rangle> \<Down> BoolV (True)"
  using assms by (auto intro: RedUnOp)

lemma equiv_preserves_value:
  assumes "a \<sim> b"
    and "red_expr \<Lambda> \<Gamma> \<Omega> a ns (BoolV boolean)"
  shows "red_expr \<Lambda> \<Gamma> \<Omega> b ns (BoolV boolean)"
  using assms
proof cases
  case (neg_refl e1)
...
next
  case (neg_eq e1 e2)
  from this assms have unop_red: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>UnOp unop.Not (e1 \<guillemotleft>Eq\<guillemotright> e2), ns\<rangle> \<Down> BoolV boolean" by simp
  from this obtain v1 v2 bopRes where
    redE1: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1, ns\<rangle> \<Down> v1" and
    redE2: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e2, ns\<rangle> \<Down> v2" and
...
next
  case (neg_neq e1 e2)
  from this assms have unop_red: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>UnOp unop.Not (e1 \<guillemotleft>Neq\<guillemotright> e2), ns\<rangle> \<Down> BoolV boolean" by simp
  from this obtain v1 v2 bopRes where
    redE1: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1, ns\<rangle> \<Down> v1" and
    redE2: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e2, ns\<rangle> \<Down> v2" and
...
next
  case (neg_lt e1 e2)
  from this assms have unop_red: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>UnOp unop.Not (e1 \<guillemotleft>Lt\<guillemotright> e2), ns\<rangle> \<Down> BoolV boolean" by simp
  from this obtain v1 v2 bopRes where
    redE1: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1, ns\<rangle> \<Down> v1" and
    redE2: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e2, ns\<rangle> \<Down> v2" and
...
next
  case (neg_le e1 e2)
  from this assms have unop_red: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>UnOp unop.Not (e1 \<guillemotleft>Le\<guillemotright> e2), ns\<rangle> \<Down> BoolV boolean" by simp
  from this obtain v1 v2 bopRes where
    redE1: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1, ns\<rangle> \<Down> v1" and
    redE2: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e2, ns\<rangle> \<Down> v2" and
...
next
  case (neg_gt e1 e2)
  from this assms have unop_red: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>UnOp unop.Not (e1 \<guillemotleft>Gt\<guillemotright> e2), ns\<rangle> \<Down> BoolV boolean" by simp
  from this obtain v1 v2 bopRes where
    redE1: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1, ns\<rangle> \<Down> v1" and
    redE2: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e2, ns\<rangle> \<Down> v2" and
...
next
  case (neg_ge e1 e2)
  from this assms have unop_red: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>UnOp unop.Not (e1 \<guillemotleft>Ge\<guillemotright> e2), ns\<rangle> \<Down> BoolV boolean" by simp
  from this obtain v1 v2 bopRes where
    redE1: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1, ns\<rangle> \<Down> v1" and
    redE2: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e2, ns\<rangle> \<Down> v2" and
...
lemma asserts_hold_if_invs_hold: 
  assumes "expr_all_sat \<Lambda> \<Gamma> \<Omega> ns1 invs"
      and "assertions = map Assert invs"
    shows "M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>assertions, Normal ns1\<rangle> [\<rightarrow>] Normal ns1"
  using assms
...
next
  ...
  from Cons(2) have prem1: "expr_all_sat \<Lambda> \<Gamma> \<Omega> ns1 invs_tail" by (simp add: expr_all_sat_def)
  from Cons(3) have prem2: "List.tl assertions = map Assert invs_tail" by simp
  from prem1 prem2 have end2: "M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>List.tl assertions,Normal ns1\<rangle> [\<rightarrow>] Normal ns1" 
    using Cons(1) by blast

  from Cons(2) have act1: "expr_sat \<Lambda> \<Gamma> \<Omega> ns1 e_inv" by (simp add: expr_all_sat_def)
  from Cons(3) have act2: "List.hd assertions = (Assert e_inv)" by simp
  from act1 act2 have end1: "M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>List.hd assertions,Normal ns1\<rangle> \<rightarrow> Normal ns1" 
...
lemma invs_hold_if_asserts_reduce: 
  assumes "M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>assertions, s0\<rangle> [\<rightarrow>] s1"
      and "s0 = Normal ns1"
      and "s1 \<noteq> Failure"
      and "assertions = map Assert invs"
    shows "expr_all_sat \<Lambda> \<Gamma> \<Omega> ns1 invs"
  using assms
...
lemma one_inv_fails_assertions: 
  assumes InvsEq: "invs = invs1 @ [I] @ invs2"
      and AllSat: "expr_all_sat \<Lambda> \<Gamma> \<Omega> ns1 invs1"
      and InvFail: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>I,ns1\<rangle> \<Down> BoolV False"
      and AssertionsEq: "assertions = map Assert invs"
    shows "M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>assertions, Normal ns1\<rangle> [\<rightarrow>] Failure"
  using assms
proof -
  from InvsEq AssertionsEq obtain assum1 a_fail assum2 where
    ...
    by simp
  from AllSat left have left_red: "M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>assum1, Normal ns1\<rangle> [\<rightarrow>] Normal ns1" using asserts_hold_if_invs_hold by simp
  from mid_fail have "M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>a_fail, Normal ns1\<rangle> \<rightarrow> Failure" using red_cmd.intros(2) assms(3) by simp
  from this left_red have "M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>assum1 @ [a_fail] @ assum2, Normal ns1\<rangle> [\<rightarrow>] Failure" using failure_stays_cmd_list 
...
lemma valid_config_implies_not_failure:
  assumes "valid_configuration \<Lambda> \<Gamma> \<Omega> posts m' s'"
  shows "s' \<noteq> Failure"
  using valid_configuration_def assms by blast

lemma valid_config_implies_satisfied_posts:
  assumes "valid_configuration \<Lambda> \<Gamma> \<Omega> posts m' s'"
  shows "is_final_config (m', s') \<Longrightarrow> (\<forall>ns_end. s' = Normal ns_end \<longrightarrow> (expr_all_sat \<Lambda> \<Gamma> \<Omega> ns_end) posts)"
  using valid_configuration_def assms by (metis)
...
lemma end_static:
  assumes "M,\<Lambda>1_local,\<Gamma>,\<Omega>,T \<turnstile> \<langle>(BigBlock any [] None None, KStop, Normal ns1)\<rangle> \<longrightarrow> (step_bb, step_cont, step_state)"
  shows "step_state \<noteq> Failure \<and> (\<forall>ns1'. step_state = Normal ns1' \<longrightarrow> M,\<Lambda>0,\<Gamma>,[] \<turnstile> \<langle>any_block ,Normal ns1\<rangle> [\<rightarrow>] Normal ns1')"
  using assms
  by (cases) auto 

lemma end_return:
  assumes "M,\<Lambda>1_local,\<Gamma>,\<Omega>,T \<turnstile> \<langle>(BigBlock any [] None (Some Return), KStop, Normal ns1)\<rangle> \<longrightarrow> (step_bb, step_cont, step_state)"
  shows "step_state \<noteq> Failure \<and> (\<forall>ns1'. step_state = Normal ns1' \<longrightarrow> M,\<Lambda>0,\<Gamma>,[] \<turnstile> \<langle>[] ,Normal ns1\<rangle> [\<rightarrow>] Normal ns1')"
  using assms
...
lemma final_is_static_propagate:
  assumes "rtranclp (red_bigblock M \<Lambda> \<Gamma> \<Omega> T) start_config end_config" 
...
lemma magic_propagates: 
  assumes "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> (bb, cont, Magic) -n\<longrightarrow>^j (reached_bb, reached_cont, reached_state)"
...
next
  ...
  from this obtain first_inter where 
    red1: "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> \<langle>(bb, cont, Magic)\<rangle> \<longrightarrow> first_inter" and 
    red_rest: "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> first_inter -n\<longrightarrow>^j' (reached_bb, reached_cont, reached_state)"
...
lemma push_through_assumption_test1: 
  assumes ExtendedCorrect: "(\<And> s2'.(red_cmd_list M \<Lambda> \<Gamma> \<Omega> (c#cs2) (Normal ns1) s2') \<Longrightarrow> s2' \<noteq> Failure)"
      and  assume_cmd: "c = Assume guard"
      and guard_holds: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>guard, ns1\<rangle> \<Down> LitV (LBool True)"
    shows "(\<And> s2'.(red_cmd_list M \<Lambda> \<Gamma> \<Omega> cs2 (Normal ns1) s2') \<Longrightarrow> s2' \<noteq> Failure)"  
...
lemma push_through_assumption0: 
  assumes assume_cmd: "c = Assume guard"
      and guard_holds: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>guard, ns1\<rangle> \<Down> LitV (LBool True)"
    shows "\<And> s. (red_cmd_list M \<Lambda> \<Gamma> \<Omega> (cs2) (Normal ns1) s) \<Longrightarrow> (red_cmd_list M \<Lambda> \<Gamma> \<Omega> (c#cs2) (Normal ns1) s)" 
...
lemma push_through_assumption1: 
  assumes assume_cmd: "c = Assume not_guard"
      ...
      and guard_fails: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>guard, ns1\<rangle> \<Down> LitV (LBool False)"
    shows "\<And> s. (red_cmd_list M \<Lambda> \<Gamma> \<Omega> (cs2) (Normal ns1) s) \<Longrightarrow> (red_cmd_list M \<Lambda> \<Gamma> \<Omega> (c#cs2) (Normal ns1) s)"
...
lemma guard_holds_push_through_assumption: 
  assumes block_correctness:  
    "reached_state \<noteq> Failure \<and> 
        (\<forall> ns1'. reached_state = Normal ns1' \<longrightarrow> (red_cmd_list M \<Lambda> \<Gamma> \<Omega> (cs2) (Normal ns1) (Normal ns1')))"
      and assume_cmd: "c = Assume guard"
      and guard_holds: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>guard, ns1\<rangle> \<Down> LitV (LBool True)"
    shows "reached_state \<noteq> Failure \<and> 
           (\<forall> ns1'. reached_state = Normal ns1' \<longrightarrow> (red_cmd_list M \<Lambda> \<Gamma> \<Omega> (c#cs2) (Normal ns1) (Normal ns1')))" 
  ...
  assumes block_correctness: 
    "reached_state \<noteq> Failure \<and> 
     (\<forall> ns1'. reached_state = Normal ns1' \<longrightarrow> (red_cmd_list M \<Lambda> \<Gamma> \<Omega> (cs2) (Normal ns1) (Normal ns1')))"
      ...
      and NotGuardEquiv: "UnOp Not guard \<sim> not_guard"
      and guard_fails: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>guard, ns1\<rangle> \<Down> LitV (LBool False)"
    shows "reached_state \<noteq> Failure \<and> (\<forall> ns1'. reached_state = Normal ns1' \<longrightarrow> (red_cmd_list M \<Lambda> \<Gamma> \<Omega> (c#cs2) (Normal ns1) (Normal ns1')))" 
...
lemma guard_fails_push_through_assumption2: 
  assumes block_correctness: "reached_state \<noteq> Failure \<and> (\<forall> ns1'. reached_state = Normal ns1' \<longrightarrow> (red_cmd_list M \<Lambda> \<Gamma> \<Omega> (c#cs2) (Normal ns1) (Normal ns1')))"
      and assume_cmd: "c = Assume not_guard"
      ...
      and guard_fails: "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>guard, ns1\<rangle> \<Down> LitV (LBool False)"
     shows "reached_state \<noteq> Failure \<and> (\<forall> ns1'. reached_state = Normal ns1' \<longrightarrow> (red_cmd_list M \<Lambda> \<Gamma> \<Omega> (cs2) (Normal ns1) (Normal ns1')))" 
     using assume_cmd assume_true_cmds block_correctness by blast

lemma correctness_propagates_through_assumption:
  assumes "\<forall>m s. (M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n0, Normal ns1) -n\<rightarrow>* (m, s)) \<longrightarrow> s \<noteq> Failure"
      and "node_to_block G ! n0 = [Assume c]"
      and "UnOp Not guard \<sim> c"
      and "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>guard, ns1\<rangle> \<Down> BoolV False"
      and "List.member (out_edges G ! n0) n1"
    shows "\<And> m s. (M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n1, Normal ns1) -n\<rightarrow>* (m, s)) \<Longrightarrow> s \<noteq> Failure"
proof -
  fix m1 s1
  have "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>c, ns1\<rangle> \<Down> BoolV True" using assms(3-4) equiv_preserves_value false_equals_not_true by blast
  then have a1: "(M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>[Assume c], Normal ns1\<rangle> [\<rightarrow>] (Normal ns1))" by (meson RedAssumeOk RedCmdListCons RedCmdListNil)
  show "(M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n1, Normal ns1) -n\<rightarrow>* (m1, s1)) \<Longrightarrow> s1 \<noteq> Failure" 
  proof -
    assume "(M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n1, Normal ns1) -n\<rightarrow>* (m1, s1))"
...
lemma correctness_propagates_through_assumption2:
  assumes "\<forall>m s. (M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n0, Normal ns1) -n\<rightarrow>* (m, s)) \<longrightarrow> s \<noteq> Failure"
      ...
      and "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>guard, ns1\<rangle> \<Down> BoolV True"
      and "List.member (out_edges G ! n0) n1"
    shows "\<And> m s. (M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n1, Normal ns1) -n\<rightarrow>* (m, s)) \<Longrightarrow> s \<noteq> Failure"
proof -
  fix m1 s1
  have a1: "(M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>[Assume guard], Normal ns1\<rangle> [\<rightarrow>] (Normal ns1))" 
...
lemma correctness_propagates_through_assumption3:
  assumes "\<forall>m s. (M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n0, Normal ns1) -n\<rightarrow>* (m, s)) \<longrightarrow> 
                   (is_final_config (m, s) \<longrightarrow> 
                      (\<forall>ns_end. s = Normal ns_end \<longrightarrow> (expr_all_sat \<Lambda>1_local \<Gamma> \<Omega> ns_end) posts))"
      and "node_to_block G ! n0 = [Assume c]"
      and "UnOp Not guard \<sim> c"
      and "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>guard, ns1\<rangle> \<Down> BoolV False"
      and "List.member (out_edges G ! n0) n1"
    shows "\<And> m s. (M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n1, Normal ns1) -n\<rightarrow>* (m, s)) \<Longrightarrow> 
                   (is_final_config (m, s) \<Longrightarrow> 
                   (\<forall>ns_end. s = Normal ns_end \<longrightarrow> (expr_all_sat \<Lambda>1_local \<Gamma> \<Omega> ns_end) posts))"
proof -
  fix m1 s1
  have "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>c, ns1\<rangle> \<Down> BoolV True" using assms(3-4) equiv_preserves_value false_equals_not_true by blast
  then have a1: "(M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>[Assume c], Normal ns1\<rangle> [\<rightarrow>] (Normal ns1))" by (meson RedAssumeOk RedCmdListCons RedCmdListNil)
  show "(M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n1, Normal ns1) -n\<rightarrow>* (m1, s1)) \<Longrightarrow> 
          (is_final_config (m1, s1) \<Longrightarrow> 
          (\<forall>ns_end. s1 = Normal ns_end \<longrightarrow> (expr_all_sat \<Lambda>1_local \<Gamma> \<Omega> ns_end) posts))" 
  proof -
    assume "(M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n1, Normal ns1) -n\<rightarrow>* (m1, s1))"
    thus "(is_final_config (m1, s1) \<Longrightarrow> (\<forall>ns_end. s1 = Normal ns_end \<longrightarrow> (expr_all_sat \<Lambda>1_local \<Gamma> \<Omega> ns_end) posts))" 
...
lemma correctness_propagates_through_assumption4:
  assumes "\<forall>m s. (M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n0, Normal ns1) -n\<rightarrow>* (m, s)) \<longrightarrow> 
                 ...
                 (expr_all_sat \<Lambda>1_local \<Gamma> \<Omega> ns_end) posts))"
      and "node_to_block G ! n0 = [Assume guard]"
      and "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>guard, ns1\<rangle> \<Down> BoolV True"
      and "List.member (out_edges G ! n0) n1"
    shows "\<And> m s. (M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n1, Normal ns1) -n\<rightarrow>* (m, s)) \<Longrightarrow> (is_final_config (m, s) \<Longrightarrow> 
                   (\<forall>ns_end. s = Normal ns_end \<longrightarrow> (expr_all_sat \<Lambda>1_local \<Gamma> \<Omega> ns_end) posts))"
proof -
  fix m1 s1
  have a1: "(M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>[Assume guard], Normal ns1\<rangle> [\<rightarrow>] (Normal ns1))" 
...
proof -
  fix m1 s1
  have a1: "(M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>[], Normal ns1\<rangle> [\<rightarrow>] (Normal ns1))" by (rule RedCmdListNil)
  show "(M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n1, Normal ns1) -n\<rightarrow>* (m1, s1)) \<Longrightarrow> s1 \<noteq> Failure" 
  proof -
    assume "(M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n1, Normal ns1) -n\<rightarrow>* (m1, s1))"
...
proof -
  fix m1 s1
  have a1: "(M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>[], Normal ns1\<rangle> [\<rightarrow>] (Normal ns1))" by (meson RedAssumeOk assms(3) red_cmd_list.simps)
  show "(M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n1, Normal ns1) -n\<rightarrow>* (m1, s1)) \<Longrightarrow> 
        (is_final_config (m1, s1) \<Longrightarrow> 
         (\<forall>ns_end. s1 = Normal ns_end \<longrightarrow> (expr_all_sat \<Lambda>1_local \<Gamma> \<Omega> ns_end) posts))" 
  proof -
...
next
  ...
  proof -
    from 1 assms obtain inter_bb inter_cont inter_state  where
      step1: "(red_bigblock M \<Lambda> \<Gamma> \<Omega> T (BigBlock name [] None None, KEndBlock cont0, Normal ns3) (inter_bb, inter_cont, inter_state))" and 
      rest: "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile>(inter_bb, inter_cont, inter_state) -n\<longrightarrow>^l1 (reached_bb, reached_cont, reached_state)" 
...
lemma ending_after_skipping_endblock:
  assumes "j = Suc j'" 
      and "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile>(bb, KEndBlock cont0, Normal ns1'') -n\<longrightarrow>^j' (reached_bb, reached_cont, reached_state)" 
      and "bb = BigBlock None [] None None"
      and "\<And>m3 s3. (M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n, Normal ns1'') -n\<rightarrow>* (m3, s3)) \<Longrightarrow> s3 \<noteq> Failure"
      and "\<And>m' s'. (M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n, Normal ns1'') -n\<rightarrow>* (m', s')) \<Longrightarrow>
           is_final_config (m', s') \<Longrightarrow> \<forall>ns_end. s' = Normal ns_end \<longrightarrow> (expr_all_sat \<Lambda>1_local \<Gamma> \<Omega> ns_end) posts"
      and "(cont_guard = Some guard) \<Longrightarrow> (\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>guard,ns1''\<rangle> \<Down> BoolV False)" 
      and "\<And> j''. 
            j' = Suc j'' \<Longrightarrow>                           
            M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile>(bb, cont0, Normal ns1'') -n\<longrightarrow>^j'' (reached_bb, reached_cont, reached_state) \<Longrightarrow>
...
proof -
  ...
  next 
    ...
    thus ?thesis
    proof -
      obtain l2_conc where conc_trace: "(M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile>(bb, cont0, Normal ns1'') -n\<longrightarrow>^l2_conc (reached_bb, reached_cont, reached_state))" and 
        succ_rel: "(j' = Suc l2_conc)"
        using \<open>\<exists>l2. (M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile>(bb, cont0, Normal ns1'') -n\<longrightarrow>^l2 (reached_bb, reached_cont, reached_state)) \<and> j' = Suc l2\<close> by blast
      show ?thesis
        apply (rule assms(7))
        apply (rule succ_rel)
...
next
  ...
  proof (cases l1)
    case 0
    from 1 assms this have "(red_bigblock M \<Lambda> \<Gamma> \<Omega> T (BigBlock None [] None None, KEndBlock (KSeq bb_next cont0), Normal ns3) (reached_bb, reached_cont, reached_state))"
      by fastforce
    then show ?thesis
    proof cases
  ...
  next
    ...
    from 2 1 assms obtain inter_bb inter_cont inter_state inter_bb2 inter_cont2 inter_state2 where
      step1: "(red_bigblock M \<Lambda> \<Gamma> \<Omega> T (BigBlock None [] None None, KEndBlock (KSeq bb_next cont0), Normal ns3) (inter_bb, inter_cont, inter_state))" and 
      step2: "(red_bigblock M \<Lambda> \<Gamma> \<Omega> T (inter_bb, inter_cont, inter_state) (inter_bb2, inter_cont2, inter_state2))" and
      rest: "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile>(inter_bb2, inter_cont2, inter_state2) -n\<longrightarrow>^l2 (reached_bb, reached_cont, reached_state)" 
      by (metis (no_types) prod_cases3 relpowp_Suc_D2)
    ...
    proof cases 
      ...
      thus ?thesis  
        ...
        by fastforce
    qed auto
    hence "(M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile>(bb_next, cont0, Normal ns3) -n\<longrightarrow>^l2 (reached_bb, reached_cont, reached_state)) \<and> (l = Suc (Suc l2))" 
...
lemma ending_after_skipping_endblock2:
  assumes "j = Suc j'" 
      and "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile>(bb, KEndBlock (KSeq bigblock_next cont0), Normal ns1'') -n\<longrightarrow>^j' (reached_bb, reached_cont, reached_state)" 
      and "bb = BigBlock None [] None None"
      and "\<And>m3 s3. (M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n, Normal ns1'') -n\<rightarrow>* (m3, s3)) \<Longrightarrow> s3 \<noteq> Failure"
      and "\<And>m' s'. (M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n, Normal ns1'') -n\<rightarrow>* (m', s')) \<Longrightarrow>
           is_final_config (m', s') \<Longrightarrow> \<forall>ns_end. s' = Normal ns_end \<longrightarrow> (expr_all_sat \<Lambda>1_local \<Gamma> \<Omega> ns_end) posts"
      ...
      and "\<And> j''. 
            ...
            M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile>(bigblock_next, cont0, Normal ns1'') -n\<longrightarrow>^j'' (reached_bb, reached_cont, reached_state) \<Longrightarrow>
           (\<And>m' s'. M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n, Normal ns1'') -n\<rightarrow>* (m', s') \<Longrightarrow> s' \<noteq> Failure) \<Longrightarrow>
           (\<And>m' s'. (M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n, Normal ns1'') -n\<rightarrow>* (m', s')) \<Longrightarrow>
           is_final_config (m', s') \<Longrightarrow> \<forall>ns_end. s' = Normal ns_end \<longrightarrow> (expr_all_sat \<Lambda>1_local \<Gamma> \<Omega> ns_end) posts) \<Longrightarrow>
...
proof -
  ...
  next 
    ...
    thus ?thesis
    proof -
      obtain l2_conc where conc_trace: "(M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile>(bigblock_next, cont0, Normal ns1'') -n\<longrightarrow>^l2_conc (reached_bb, reached_cont, reached_state))" and 
        succ_rel: "(j' = Suc (Suc l2_conc))"
        using \<open>\<exists>l2. (M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile>(bigblock_next, cont0, Normal ns1'') -n\<longrightarrow>^l2 (reached_bb, reached_cont, reached_state)) \<and> j' = Suc (Suc l2)\<close>
        by blast
      show ?thesis
        apply (rule assms(7))
        apply (rule succ_rel)
...
next
  ...
  proof -
    from 1 assms obtain inter_bb inter_cont inter_state where
      step1: "(red_bigblock M \<Lambda> \<Gamma> \<Omega> T (bb0, cont0, Normal ns) (inter_bb, inter_cont, inter_state))" and 
      rest: "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile>(inter_bb, inter_cont, inter_state) -n\<longrightarrow>^l1 (reached_bb, reached_cont, reached_state)" 
      by (metis (no_types) prod_cases3 relpowp_Suc_D2)
    ...
    hence "(M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile>(BigBlock name [] (Some loop) None, KEndBlock cont0, Normal ns) -n\<longrightarrow>^l1 (reached_bb, reached_cont, reached_state)) \<and> (l = Suc l1)" 
...
lemma ending_after_unwrapping:
  assumes "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile>(bb, cont0, Normal ns1'') -n\<longrightarrow>^j (reached_bb, reached_cont, reached_state)" 
      ...
      and "\<And> j''. 
            j = Suc j'' \<Longrightarrow>
            M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile>(BigBlock name [] (Some loop) None, KEndBlock cont0, Normal ns1'') -n\<longrightarrow>^j'' (reached_bb, reached_cont, reached_state) \<Longrightarrow>
           (\<And>m' s'. M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n, Normal ns1'') -n\<rightarrow>* (m', s') \<Longrightarrow> s' \<noteq> Failure) \<Longrightarrow>
           (\<And>m' s'. (M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n, Normal ns1'') -n\<rightarrow>* (m', s')) \<Longrightarrow>
           is_final_config (m', s') \<Longrightarrow> \<forall>ns_end. s' = Normal ns_end \<longrightarrow> (expr_all_sat \<Lambda>1_local \<Gamma> \<Omega> ns_end) posts) \<Longrightarrow>
           (valid_configuration \<Lambda> \<Gamma> \<Omega> posts reached_bb reached_cont reached_state)"
...
proof -
  ...
  next 
    ...
    thus ?thesis
    proof -
      obtain l2_conc where conc_trace: "(M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile>(BigBlock name [] (Some loop) None, KEndBlock cont0, Normal ns1'') -n\<longrightarrow>^l2_conc (reached_bb, reached_cont, reached_state))" and 
        succ_rel: "(j = Suc l2_conc)"
        using \<open>\<exists>l2. (M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile>(BigBlock name [] (Some loop) None, KEndBlock cont0, Normal ns1'') -n\<longrightarrow>^l2 (reached_bb, reached_cont, reached_state)) \<and> j = Suc l2\<close> by blast
      show ?thesis
        apply (rule assms(5))
        apply (rule succ_rel)
        apply (rule conc_trace)
...
next
  ...
  proof (cases l1)
    ...
    from 1 assms this have 
      "(red_bigblock M \<Lambda> \<Gamma> \<Omega> T (BigBlock None [] None None, KEndBlock (KSeq (BigBlock name [] (Some (WhileWrapper str)) tr) cont0), Normal ns3) (reached_bb, reached_cont, reached_state))"
      by fastforce
    then show ?thesis
    proof cases
      case RedSkipEndBlock thus ?thesis by (simp add: Ast.valid_configuration_def)
  ...
  next
    ...
    proof (cases l2)
      ...
      from 2 1 assms obtain inter_bb inter_cont inter_state  where
        step1: "(red_bigblock M \<Lambda> \<Gamma> \<Omega> T (BigBlock None [] None None, KEndBlock (KSeq (BigBlock name [] (Some (WhileWrapper str)) tr) cont0), Normal ns3) (inter_bb, inter_cont, inter_state))" and 
        step2: "(red_bigblock M \<Lambda> \<Gamma> \<Omega> T (inter_bb, inter_cont, inter_state) (reached_bb, reached_cont, reached_state))" 
        using "0" by auto
    ...
    next
      ...
      from 3 2 1 assms obtain inter_bb inter_cont inter_state inter_bb2 inter_cont2 inter_state2 inter_bb3 inter_cont3 inter_state3 where
        step1: "(red_bigblock M \<Lambda> \<Gamma> \<Omega> T (BigBlock None [] None None, KEndBlock (KSeq (BigBlock name [] (Some (WhileWrapper str)) tr) cont0), Normal ns3) (inter_bb, inter_cont, inter_state))" and 
        step2: "(red_bigblock M \<Lambda> \<Gamma> \<Omega> T (inter_bb, inter_cont, inter_state) (inter_bb2, inter_cont2, inter_state2))" and 
        step3: "(red_bigblock M \<Lambda> \<Gamma> \<Omega> T (inter_bb2, inter_cont2, inter_state2) (inter_bb3, inter_cont3, inter_state3))" and
        rest: "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> (inter_bb3, inter_cont3, inter_state3) -n\<longrightarrow>^l3 (reached_bb, reached_cont, reached_state)" 
      ...
      qed auto
      hence "(M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile>((BigBlock name [] (Some str) tr), KEndBlock cont0, Normal ns3) -n\<longrightarrow>^l3 (reached_bb, reached_cont, reached_state)) \<and> (l = Suc (Suc (Suc l3)))" 
...
lemma ending_after_skipping_endblock_and_unwrapping:
  assumes "j = Suc j'"
      and "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile>(bb,
           ...
           (reached_bb, reached_cont, reached_state)"
      and "bb = BigBlock None [] None None"
      and corr: "\<forall>m3 s3. (M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n, Normal ns1'') -n\<rightarrow>* (m3, s3)) \<longrightarrow> s3 \<noteq> Failure"
      and "\<And>m' s'. (M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n, Normal ns1'') -n\<rightarrow>* (m', s')) \<Longrightarrow>
           is_final_config (m', s') \<Longrightarrow> \<forall>ns_end. s' = Normal ns_end \<longrightarrow> (expr_all_sat \<Lambda>1_local \<Gamma> \<Omega> ns_end) posts"
      and guard_false: "(cont_guard = Some guard) \<Longrightarrow> (\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>guard,ns1''\<rangle> \<Down> BoolV False)"
      ...
      and "\<And> j'''.
          ...
          M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile>((BigBlock None [] (Some (ParsedWhile next_guard next_invs (next_body_bb#body_bbs))) None), KEndBlock cont1, Normal ns1'') -n\<longrightarrow>^j''' 
  ...
  next 
    ...
    proof -
      obtain l3_conc where 
        conc_trace: "(M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile>((BigBlock None [] (Some (ParsedWhile next_guard next_invs (next_body_bb#body_bbs))) None), KEndBlock cont1, Normal ns1'') 
...
lemma block_local_rel_generic:
  assumes block_rel: "ast_cfg_rel guard invs bb cs2"
      and "guard = None"
      and "invs = []"
      and Red_bb_to: "red_bigblock M \<Lambda> \<Gamma> \<Omega> T (bb, cont0, (Normal ns1)) (reached_bb, reached_cont, reached_state)" 
      and Red_impl: "(\<And> s2'.((red_cmd_list M \<Lambda> \<Gamma> \<Omega> cs2 (Normal ns1) s2') \<Longrightarrow> (s2' \<noteq> Failure)))"
      and "bb = (BigBlock name cs1 any_str any_tr)"
      and "cs1 \<noteq> Nil"
      and "cs2 \<noteq> Nil"
    shows "reached_state \<noteq> Failure  \<and>
           (\<forall>ns1'. reached_state = Normal ns1' \<longrightarrow> (M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>cs2, Normal ns1\<rangle> [\<rightarrow>] Normal ns1'))" 
  using assms
proof (induction arbitrary: ns1)
  ...
  next
    case (Cons a list)
    then have "red_bigblock M \<Lambda> \<Gamma> \<Omega> T ((BigBlock name (a#list) any_str any_tr), cont0, (Normal ns1)) (reached_bb, reached_cont, reached_state)" 
      using Rel_Main_test by blast
    then have "M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>(a#list), Normal ns1\<rangle> [\<rightarrow>] reached_state" using Rel_Main_test(5) 
    proof cases
      case RedSimpleCmds thus ?thesis by blast
    qed
    then have "M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>cs1, Normal ns1\<rangle> [\<rightarrow>] reached_state" using Cons by simp
...
lemma block_local_rel_loop_head:
  assumes block_rel: "ast_cfg_rel None assert_invs bb assertions"
      ...
      and Red_bb: "red_bigblock M \<Lambda> \<Gamma> \<Omega> T (bb, cont0, (Normal ns1)) (reached_bb, reached_cont, reached_state)" 
      and Red_impl: "(\<And> s2'.((red_cmd_list M \<Lambda> \<Gamma> \<Omega> assertions (Normal ns1) s2') \<Longrightarrow> (s2' \<noteq> Failure)))"
    shows "reached_state \<noteq> Failure  \<and>
           (\<forall>ns1'. reached_state = Normal ns1' \<longrightarrow> (M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>assertions, Normal ns1\<rangle> [\<rightarrow>] Normal ns1'))" 
  using assms
proof cases
  case Rel_Invs
...
lemma generic_ending_block_global_rel:
  assumes syn_rel: "ast_cfg_rel None [] bb cs2"
      and j_step_ast_trace: "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> (bb, cont0, (Normal ns1)) -n\<longrightarrow>^j (reached_bb, reached_cont, reached_state)"
      ...
      and block_id:
          "(related_block = cs2) \<or> 
           (related_block = c#cs2) \<and> c = Assume guard \<and> (red_expr \<Lambda> \<Gamma> \<Omega> guard ns1 (BoolV True)) \<or> 
           (related_block = c#cs2) \<and> c = Assume not_guard \<and> (UnOp Not guard \<sim> not_guard) \<and> (red_expr \<Lambda> \<Gamma> \<Omega> guard ns1 (BoolV False))"
      and "out_edges G ! n = []"
      and cfg_reaches_not_failure: "\<And> m' s'. (red_cfg_multi M \<Lambda> \<Gamma> \<Omega> G ((Inl n),(Normal ns1)) (m',s')) \<Longrightarrow> (s' \<noteq> Failure)"
      and cfg_satisfies_posts: "\<And> m' s'. (red_cfg_multi M \<Lambda> \<Gamma> \<Omega> G ((Inl n),(Normal ns1)) (m',s')) \<Longrightarrow> 
                                      is_final_config (m',s') \<Longrightarrow> (\<forall> ns_end. s' = Normal ns_end \<longrightarrow> (expr_all_sat \<Lambda> \<Gamma> \<Omega> ns_end) post_invs)"
      and local_rel: "\<And> step_bb step_cont step_state. 
                    red_bigblock M \<Lambda> \<Gamma> \<Omega> T (bb, KStop, (Normal ns1)) (step_bb, step_cont, step_state) \<Longrightarrow> 
...
proof (cases cs2)
  ...
  proof (cases any_tr)
    ...
    proof -
      have complete: "(red_cfg_multi M \<Lambda> \<Gamma> \<Omega> G ((Inl n),(Normal ns1)) (Inr (), Normal ns1))" 
    ...
    next
      ...
      proof (cases a)
        ...
        from Suc j_step_ast_trace assms(3) obtain inter_bb inter_cont inter_state where
          step0: "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> \<langle>((BigBlock name cs1 None any_tr), cont0, (Normal ns1))\<rangle> \<longrightarrow> (inter_bb, inter_cont, inter_state)" and
          rest0: "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> (inter_bb, inter_cont, inter_state) -n\<longrightarrow>^j' (reached_bb, reached_cont, reached_state)"
          by (metis prod_cases3 relpowp_Suc_D2) 
        from cfg_reaches_not_failure have 
          cfg_local: "(\<And> s2'.((red_cmd_list M \<Lambda> \<Gamma> \<Omega> (node_to_block(G) ! n) (Normal ns1) s2') \<Longrightarrow> (s2' \<noteq> Failure)))"
        ...
        from this cfg_local step0 have 
          "inter_state \<noteq> Failure  \<and>
            (\<forall>ns1'. inter_state = Normal ns1' \<longrightarrow> (M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>node_to_block(G) ! n, Normal ns1\<rangle> [\<rightarrow>] Normal ns1'))"
        ...
        hence "(red_cfg M \<Lambda> \<Gamma> \<Omega> G ((Inl n),(Normal ns1)) (Inr (), Normal ns1))"
          by (simp add: RedNormalReturn 
              \<open>inter_state \<noteq> Failure \<and> (\<forall>ns1'. inter_state = Normal ns1' \<longrightarrow> M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>node_to_block G ! n,Normal ns1\<rangle> [\<rightarrow>] Normal ns1')\<close> 
              assms(8))

        hence "(red_cfg_multi M \<Lambda> \<Gamma> \<Omega> G ((Inl n),(Normal ns1)) (Inr (), Normal ns1))" by simp
        hence "(expr_all_sat \<Lambda> \<Gamma> \<Omega> ns1) post_invs" 
...
next
  ...
  next
    ...
    from this j_step_ast_trace assms(3) obtain inter_bb inter_cont inter_state where
      step: "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> \<langle>((BigBlock name cs1 None any_tr), cont0, (Normal ns1))\<rangle> \<longrightarrow> (inter_bb, inter_cont, inter_state)" and
      rest: "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> (inter_bb, inter_cont, inter_state) -n\<longrightarrow>^j' (reached_bb, reached_cont, reached_state)"
      by (metis prod_cases3 relpowp_Suc_D2) 
    then show ?thesis 
    proof (cases any_tr)
      case None
      ...
      have Red_impl: "(\<And> s2'.((red_cmd_list M \<Lambda> \<Gamma> \<Omega> (node_to_block(G) ! n) (Normal ns1) s2') \<Longrightarrow> (s2' \<noteq> Failure)))"
      ...
      hence "(\<forall>ns1'. inter_state = Normal ns1' \<longrightarrow> red_cfg M \<Lambda> \<Gamma> \<Omega> G ((Inl n),(Normal ns1)) (Inr (), Normal ns1'))"
        by (simp add: RedCmdListNil RedNormalReturn assms(7-8) local.Cons)

      hence "(\<forall>ns1'. inter_state = Normal ns1' \<longrightarrow> red_cfg_multi M \<Lambda> \<Gamma> \<Omega> G ((Inl n),(Normal ns1)) (Inr (), Normal ns1'))" 
        by blast
      hence posts_sat: "\<forall>ns1'. inter_state = Normal ns1' \<longrightarrow> (expr_all_sat \<Lambda> \<Gamma> \<Omega> ns1') post_invs" 
        using cfg_satisfies_posts is_final_config.simps(2) by blast
    ...
    next
      ...
      next
        ...
        hence "(\<forall>ns1'. inter_state = Normal ns1' \<longrightarrow> red_cfg_multi M \<Lambda> \<Gamma> \<Omega> G ((Inl n),(Normal ns1)) (Inr (), Normal ns1'))" by blast
        hence posts_sat: "\<forall>ns1'. inter_state = Normal ns1' \<longrightarrow> (expr_all_sat \<Lambda> \<Gamma> \<Omega> ns1') post_invs" 
          using cfg_satisfies_posts is_final_config.simps(2) by blast
        ...
        proof (cases inter_state)
          ...
          next
            ...
            from this rest obtain inter_bb2 inter_cont2 inter_state2 where
              snd_step: "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> \<langle>(inter_bb, inter_cont, inter_state)\<rangle> \<longrightarrow> (inter_bb2, inter_cont2, inter_state2)" and
              snd_rest: "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> (inter_bb2, inter_cont2, inter_state2) -n\<longrightarrow>^j'' (reached_bb, reached_cont, reached_state)"
...
lemma block_global_rel_while_successor:
  assumes j_step_ast_trace: 
           "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> (bb, cont1, Normal ns1) -n\<longrightarrow>^j (reached_bb, reached_cont, reached_state)"
    ...
    "(related_block = cmds) \<or> 
       (related_block = c#cmds) \<and> c = Assume entry_guard \<and> (red_expr \<Lambda> \<Gamma> \<Omega> entry_guard ns1 (BoolV True)) \<or> 
       (related_block = c#cmds) \<and> c = Assume not_guard \<and> (UnOp Not entry_guard \<sim> not_guard) \<and> (red_expr \<Lambda> \<Gamma> \<Omega> entry_guard ns1 (BoolV False))"
      and cfg_is_correct: "\<And> m' s'. (red_cfg_multi M \<Lambda> \<Gamma> \<Omega> G ((Inl n),(Normal ns1)) (m',s')) \<Longrightarrow> (s' \<noteq> Failure)"
      and cfg_satisfies_posts: "\<And> m' s'. (red_cfg_multi M \<Lambda> \<Gamma> \<Omega> G ((Inl n),(Normal ns1)) (m',s')) \<Longrightarrow> 
    ...
    (red_bigblock M \<Lambda> \<Gamma> \<Omega> T (bb, cont1, (Normal ns1)) (reached_bb_inter, reached_cont_inter, reached_state_inter)) \<Longrightarrow> 
    (\<And> s2'.((red_cmd_list M \<Lambda> \<Gamma> \<Omega> (node_to_block G ! n) (Normal ns1) s2') \<Longrightarrow> (s2' \<noteq> Failure))) \<Longrightarrow>   
    (reached_state_inter \<noteq> Failure  \<and> (\<forall>ns1'. reached_state_inter = Normal ns1' \<longrightarrow> (M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>(node_to_block G ! n), Normal ns1\<rangle> [\<rightarrow>] Normal ns1')))"
      and global_rel_succ:
       "\<And> ns2 k.
         k < j \<Longrightarrow>
         (\<forall>msuc2. List.member (out_edges(G) ! n) msuc2 \<longrightarrow> (\<forall>m3 s3. (M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile> (Inl msuc2, Normal ns2) -n\<rightarrow>* (m3, s3)) \<longrightarrow> s3 \<noteq> Failure)) \<Longrightarrow>
         (\<forall>msuc2. List.member (out_edges(G) ! n) msuc2 \<longrightarrow> (\<forall>m' s'. (M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl msuc2, Normal ns2) -n\<rightarrow>* (m', s')) \<longrightarrow>
                                                             is_final_config (m', s') \<longrightarrow> 
...
next
  ...
  from this j_step_ast_trace assms(3) obtain inter_bb inter_cont inter_state where
    first_step: "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> \<langle>((BigBlock name cmds (Some (WhileWrapper (ParsedWhile guard invs (body_bb0#body_bbs)))) None), cont1, Normal ns1)\<rangle> \<longrightarrow> (inter_bb, inter_cont, inter_state)" and 
    rest: "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> (inter_bb, inter_cont, inter_state) -n\<longrightarrow>^j' (reached_bb, reached_cont, reached_state)"
    by (metis (no_types) get_state.cases relpowp_Suc_D2)
  ...
  have Red_impl: "(\<And> s2'.((red_cmd_list M \<Lambda> \<Gamma> \<Omega> (node_to_block G ! n) (Normal ns1) s2') \<Longrightarrow> (s2' \<noteq> Failure)))" using dag_verifies_propagate_2 cfg_is_correct assms(5) 
    by blast
  have local_conclusion: "inter_state \<noteq> Failure  \<and> (\<forall>ns1'. inter_state = Normal ns1' \<longrightarrow> (M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>(node_to_block G ! n), Normal ns1\<rangle> [\<rightarrow>] Normal ns1'))" 
    using Red_impl first_step assms(3-4) block_local_rel_generic syn_rel block_local_rel by blast
  show ?thesis 
  proof (cases inter_state)
    case (Normal x1)
    hence "(M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>(node_to_block G ! n), Normal ns1\<rangle> [\<rightarrow>] inter_state)" using local_conclusion by blast
    then show ?thesis
    proof (cases j')
      case 0
      then show ?thesis 
    ...
    next
      case 2: (Suc j'')
      hence Red_cfg_conc: 
        "(\<forall>msuc2. List.member (out_edges(G) ! n) msuc2 \<longrightarrow> (\<forall>m3 s3. (M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile> (Inl msuc2, inter_state) -n\<rightarrow>* (m3, s3)) \<longrightarrow> s3 \<noteq> Failure))" 
        using dag_verifies_propagate Normal \<open>M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>(node_to_block G ! n),Normal ns1\<rangle> [\<rightarrow>] inter_state\<close> assms(5) cfg_is_correct 
        by blast

      hence Red_cfg_sat_conc: 
        "(\<forall>msuc2. List.member (out_edges(G) ! n) msuc2 \<longrightarrow> (\<forall>m' s'. (M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl msuc2, inter_state) -n\<rightarrow>* (m', s')) \<longrightarrow>
                                                             is_final_config (m', s') \<longrightarrow> 
      ...
      from 2 j_step_ast_trace assms(3) obtain inter_bb2 inter_cont2 inter_state2 where
        first_step_2: "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> \<langle>(inter_bb, inter_cont, inter_state)\<rangle> \<longrightarrow> (inter_bb2, inter_cont2, inter_state2)" and 
        rest_2: "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> (inter_bb2, inter_cont2, inter_state2) -n\<longrightarrow>^j'' (reached_bb, reached_cont, reached_state)"
...
lemma block_global_rel_loop_head:
  assumes block_rel: "ast_cfg_rel None assertions bb assertions"
      and ast_trace: "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> (bb, cont0, (Normal ns1)) -n\<longrightarrow>^j (reached_bb, reached_cont, reached_state)"
      and cfg_correct: "(\<And> m2 s2. ((red_cfg_multi M \<Lambda> \<Gamma> \<Omega> G (Inl n, Normal ns1) (m2, s2)) \<Longrightarrow> (s2 \<noteq> Failure)))"
      and cfg_satisfies_post: "(\<And> m2 s2. (red_cfg_multi M \<Lambda> \<Gamma> \<Omega> G (Inl n, Normal ns1) (m2, s2)) \<Longrightarrow>
                                        is_final_config (m2, s2) \<Longrightarrow> \<forall>ns_end. s2 = Normal ns_end \<longrightarrow> (expr_all_sat \<Lambda> \<Gamma> \<Omega> ns_end) posts)"
      and "bb = (BigBlock name [] any_str any_tr)"
      and bb_successor_while: "any_str = Some (ParsedWhile cont_guard invs (bb0#body_bbs))"
      and block_local_rel:
      "\<And> reached_bb_inter reached_cont_inter reached_state_inter.
       (red_bigblock M \<Lambda> \<Gamma> \<Omega> T (bb, cont0, (Normal ns1)) (reached_bb_inter, reached_cont_inter, reached_state_inter)) \<Longrightarrow> 
       (\<And> s2'.((red_cmd_list M \<Lambda> \<Gamma> \<Omega> assertions (Normal ns1) s2') \<Longrightarrow> 
       (s2' \<noteq> Failure))) \<Longrightarrow>   
       reached_state_inter \<noteq> Failure \<and> 
       (\<forall>ns1'. reached_state_inter = Normal ns1' \<longrightarrow> (M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>assertions, Normal ns1\<rangle> [\<rightarrow>] Normal ns1'))"
      and "node_to_block(G) ! n = assertions"
      and "cont0 = KEndBlock cont1"
      and succ_correct: 
    "\<And> ns1'' loop_guard j'. 
    j = Suc j' \<Longrightarrow>
    (\<forall>msuc2.  List.member (out_edges(G) ! n) msuc2 \<longrightarrow> (\<forall>m3 s3. ((M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile> (Inl(msuc2), Normal ns1'') -n\<rightarrow>* (m3, s3)) \<longrightarrow> s3 \<noteq> Failure))) \<Longrightarrow>
    (\<forall>msuc2.  List.member (out_edges(G) ! n) msuc2 \<longrightarrow> (\<forall>m' s'. ((M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl (msuc2), Normal ns1'') -n\<rightarrow>* (m', s')) \<longrightarrow>
                                                        is_final_config (m', s') \<longrightarrow> 
                                                        (\<forall>ns_end. s' = Normal ns_end \<longrightarrow> (expr_all_sat \<Lambda> \<Gamma> \<Omega> ns_end) posts)))) \<Longrightarrow>
    ((cont_guard = Some loop_guard) \<and> 
      (red_expr \<Lambda> \<Gamma> \<Omega> loop_guard ns1'' (BoolV True)) \<and> 
      M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> (bb0, convert_list_to_cont (( body_bbs)@[bb]) (KEndBlock cont1), (Normal ns1'')) -n\<longrightarrow>^j' (reached_bb, reached_cont, reached_state)) \<or> 
    ((cont_guard = Some loop_guard) \<and> 
      (red_expr \<Lambda> \<Gamma> \<Omega> loop_guard ns1'' (BoolV False)) \<and> 
...
proof -
  ...
  next
    ...
    from ast_trace this assms(5) obtain inter_bb inter_cont inter_state where
      first_step: "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> \<langle>((BigBlock name [] any_str any_tr), cont0, (Normal ns1))\<rangle> \<longrightarrow> (inter_bb, inter_cont, inter_state)" and
      rest: "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> (inter_bb, inter_cont, inter_state) -n\<longrightarrow>^j' (reached_bb, reached_cont, reached_state)"
      by (metis prod_cases3 relpowp_Suc_D2)
    ...
    proof (cases cont_guard)
      ...
      proof cases
        ...
        from first_step
        have succ_cfg_correct: "(\<forall>msuc2.  List.member (out_edges(G) ! n) msuc2 \<longrightarrow> (\<forall>m3 s3. ((M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile> (Inl(msuc2), inter_state) -n\<rightarrow>* (m3, s3)) \<longrightarrow> s3 \<noteq> Failure)))"
    ...
    next
      ...
      then show ?thesis 
      proof cases
        assume guard_true: "(red_expr \<Lambda> \<Gamma> \<Omega> concrete_loop_guard ns1 (BoolV True))"
        hence guard_not_false: "\<not> (red_expr \<Lambda> \<Gamma> \<Omega> concrete_loop_guard ns1 (BoolV False))" using expr_eval_determ by blast
      ...
      next
        assume guard_not_true: "\<not> (red_expr \<Lambda> \<Gamma> \<Omega> concrete_loop_guard ns1 (BoolV True))"
        thus ?thesis 
        proof cases
          assume guard_false: "(red_expr \<Lambda> \<Gamma> \<Omega> concrete_loop_guard ns1 (BoolV False))"
        ...
        next
          assume guard_not_false: "\<not> (red_expr \<Lambda> \<Gamma> \<Omega> concrete_loop_guard ns1 (BoolV False))"
          from first_step show ?thesis
          proof cases
            case RedParsedWhile_InvFail thus ?thesis using Some bb_successor_while guard_not_true by blast
...
lemma block_global_rel_if_successor:
  assumes block_rel: "ast_cfg_rel None [] bb cs2"
      ...
      and block_local_rel:
        "\<And> reached_bb_inter reached_cont_inter reached_state_inter. (red_bigblock M \<Lambda> \<Gamma> \<Omega> T ((BigBlock name cs1 any_str any_tr), cont0, (Normal ns1)) (reached_bb_inter, reached_cont_inter, reached_state_inter)) \<Longrightarrow> 
        (\<And> s2'.((red_cmd_list M \<Lambda> \<Gamma> \<Omega> (node_to_block(G) ! n) (Normal ns1) s2') \<Longrightarrow> (s2' \<noteq> Failure))) \<Longrightarrow> 
      ...
      and succ_correct: 
        ...
        ( (cont_guard = Some block_guard) \<and> 
          (red_expr \<Lambda> \<Gamma> \<Omega> block_guard ns1'' (BoolV True)) \<and> 
        ...
        ( (cont_guard = Some block_guard) \<and> 
          (red_expr \<Lambda> \<Gamma> \<Omega> block_guard ns1'' (BoolV False)) \<and>
          M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> (else0, convert_list_to_cont ( else_bbs) cont0, (Normal ns1'')) -n\<longrightarrow>^k (reached_bb, reached_cont, reached_state) ) \<or>
        ( (cont_guard = None) \<and> 
          ((M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> (then0, convert_list_to_cont ( then_bbs) cont0, (Normal ns1'')) -n\<longrightarrow>^k (reached_bb, reached_cont, reached_state)) \<or>
  ...
  next
    ...
    next
      ...
      from this assms(3) obtain inter_bb inter_cont inter_state where
        first_step: "red_bigblock M \<Lambda> \<Gamma> \<Omega> T ((BigBlock name cs1 any_str any_tr), cont0, (Normal ns1)) (inter_bb, inter_cont, inter_state)" and
        rest_of_steps: "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> (inter_bb, inter_cont, inter_state) -n\<longrightarrow>^j' (reached_bb, reached_cont, reached_state)" 
        by (metis ast_trace get_state.cases relpowp_Suc_E2)

      from cfg_correct Cons block_id
      have local_rel_corr: "(\<And> s2'.((red_cmd_list M \<Lambda> \<Gamma> \<Omega> (cs2) (Normal ns1) s2') \<Longrightarrow> (s2' \<noteq> Failure)))"
      ...
      have a2: "(inter_state \<noteq> Failure  \<and> (\<forall>ns1'. inter_state = Normal ns1' \<longrightarrow> (M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>(node_to_block G ! n), Normal ns1\<rangle> [\<rightarrow>] Normal ns1')))" 
      ...
      proof (cases inter_state)
        ...
        next
          ...
          from this rest_of_steps obtain snd_inter_bb snd_inter_cont snd_inter_state where
            snd_step: "red_bigblock M \<Lambda> \<Gamma> \<Omega> T ((BigBlock name [] any_str any_tr), cont0, inter_state)  (snd_inter_bb, snd_inter_cont, snd_inter_state)" and
            snd_rest_of_steps: "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> (snd_inter_bb, snd_inter_cont, snd_inter_state) -n\<longrightarrow>^j'' (reached_bb, reached_cont, reached_state)"
          ...
          proof (cases cont_guard)
            ...
            proof cases
              ...
              have succ_cfg_sat: "(\<forall>msuc2.  List.member (out_edges(G) ! n) msuc2 \<longrightarrow> (\<forall>m' s'. ((M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl (msuc2), inter_state) -n\<rightarrow>* (m', s')) \<longrightarrow>
                                                        is_final_config (m', s') \<longrightarrow> 
                                                        (\<forall>ns_end. s' = Normal ns_end \<longrightarrow> (expr_all_sat \<Lambda> \<Gamma> \<Omega> ns_end) posts))))"
          ...
          next
            ...
            then show ?thesis 
            proof cases
              assume guard_true: "(red_expr \<Lambda> \<Gamma> \<Omega> block_guard x1 (BoolV True))"
              hence guard_not_false: "\<not> (red_expr \<Lambda> \<Gamma> \<Omega> block_guard x1 (BoolV False))" using expr_eval_determ by blast
            ...
            next
              assume guard_not_true: "\<not> (red_expr \<Lambda> \<Gamma> \<Omega> block_guard x1 (BoolV True))"
              thus ?thesis 
              proof cases
                assume guard_false: "(red_expr \<Lambda> \<Gamma> \<Omega> block_guard x1 (BoolV False))"
              ...
              next
                assume guard_not_false2: "(\<not> (red_expr \<Lambda> \<Gamma> \<Omega> block_guard x1 (BoolV False)))" and  
                  guard_not_true2: "(\<not> (red_expr \<Lambda> \<Gamma> \<Omega> block_guard x1 (BoolV True)))"
                thus ?thesis
                proof -
      ...
      next
        case Failure
        then show ?thesis
          using \<open>inter_state \<noteq> Failure \<and> (\<forall>ns1'. inter_state = Normal ns1' \<longrightarrow> M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>(node_to_block G ! n),Normal ns1\<rangle> [\<rightarrow>] Normal ns1')\<close> 
          by linarith
      next
        case Magic
  ...
  proof (cases cs2)
    ...
    next
      ...
      from this assms(3) obtain snd_inter_bb snd_inter_cont snd_inter_state where
        snd_step: "red_bigblock M \<Lambda> \<Gamma> \<Omega> T ((BigBlock name [] any_str any_tr), cont0, (Normal ns1))  (snd_inter_bb, snd_inter_cont, snd_inter_state)" and
        snd_rest_of_steps: "M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile> (snd_inter_bb, snd_inter_cont, snd_inter_state) -n\<longrightarrow>^j' (reached_bb, reached_cont, reached_state)" 
        using Rel_Invs
      ...
      proof (cases cont_guard)
        ...
        proof cases
          ...
          have succ_cfg_correct: "(\<forall>msuc2.  List.member (out_edges(G) ! n) msuc2 \<longrightarrow> (\<forall>m3 s3. ((M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile> (Inl(msuc2), (Normal ns1)) -n\<rightarrow>* (m3, s3)) \<longrightarrow> s3 \<noteq> Failure)))"
          ...
          have succ_cfg_sat: "\<And>msuc2 m' s' ns_end.  List.member (out_edges(G) ! n) msuc2 \<Longrightarrow> (M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl (msuc2), Normal ns1) -n\<rightarrow>* (m', s')) \<Longrightarrow>
                                                      is_final_config (m', s') \<Longrightarrow> 
                                                      (s' = Normal ns_end) \<longrightarrow> (expr_all_sat \<Lambda> \<Gamma> \<Omega> ns_end) posts"
          proof
            fix msuc2 m' s' ns_end
            assume a: "List.member (out_edges G ! n) msuc2" and
              b: "M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl msuc2, Normal ns1) -n\<rightarrow>* (m', s')" and
              c: "is_final_config (m', s')" and 
              d: "(s' = Normal ns_end)"
            have one_block_advance: "M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile>(Inl n, Normal ns1) -n\<rightarrow> (Inl msuc2, Normal ns1)" 
            ...
            show "(expr_all_sat \<Lambda> \<Gamma> \<Omega> ns_end) posts" using cfg_satisfies_post b c a succ_cfg_correct one_block_advance 
      ...
      next
        ...
        then show ?thesis 
        proof cases
          assume guard_true: "(red_expr \<Lambda> \<Gamma> \<Omega> block_guard ns1 (BoolV True))"
          hence guard_not_false: "\<not> (red_expr \<Lambda> \<Gamma> \<Omega> block_guard ns1 (BoolV False))" using expr_eval_determ by blast
        ...
        next
          assume guard_not_true: "\<not> (red_expr \<Lambda> \<Gamma> \<Omega> block_guard ns1 (BoolV True))"
          thus ?thesis 
          proof cases
            assume guard_false: "(red_expr \<Lambda> \<Gamma> \<Omega> block_guard ns1 (BoolV False))"
          ...
          next
            assume guard_not_false2: "(\<not> (red_expr \<Lambda> \<Gamma> \<Omega> block_guard ns1 (BoolV False)))" and  
              guard_not_true2: "(\<not> (red_expr \<Lambda> \<Gamma> \<Omega> block_guard ns1 (BoolV True)))"
            thus ?thesis
            proof -
    ...
    "(related_block = cs2) \<or> 
      ...
      and block_local_rel: 
        "\<And> reached_bb_inter reached_cont_inter reached_state_inter. 
          ...
          reached_state_inter \<noteq> Failure \<and> 
          (\<forall>ns1'. reached_state_inter = Normal ns1' \<longrightarrow> (M,\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>(node_to_block(G) ! n), Normal ns1\<rangle> [\<rightarrow>] Normal ns1'))"
      and succ_correct: 
    "\<And>  ns1'' k.
        k < j \<Longrightarrow> 
        \<forall>msuc2.  List.member (out_edges(G) ! n) msuc2 \<longrightarrow> (\<forall>m3 s3. ((M,\<Lambda>,\<Gamma>,\<Omega>,G \<turnstile> (Inl(msuc2), Normal ns1'') -n\<rightarrow>* (m3, s3)) \<longrightarrow> s3 \<noteq> Failure)) \<Longrightarrow>
...
definition loop_IH 
  where "loop_IH j M \<Lambda> \<Gamma> \<Omega> T bb0 cont0 G block_index posts reached_bb reached_cont reached_state \<equiv> 
          (\<forall>k ns1. k < j \<longrightarrow>
                    (M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile>(bb0, cont0, Normal ns1) -n\<longrightarrow>^k (reached_bb, reached_cont, reached_state)) \<longrightarrow>
...
lemma loop_IH_apply:
  assumes "loop_IH j M \<Lambda> \<Gamma> \<Omega> T bb0 cont0 G block_index posts reached_bb reached_cont reached_state"
      and "k < j"
      and "(M,\<Lambda>,\<Gamma>,\<Omega>,T \<turnstile>(bb0, cont0, Normal ns1) -n\<longrightarrow>^k (reached_bb, reached_cont, reached_state))"
