...
lemma expr_to_vc:"\<lbrakk>\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e, ns\<rangle> \<Down> LitV (LBool True); \<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e, ns\<rangle> \<Down> LitV (LBool vc)\<rbrakk> \<Longrightarrow> vc"
...
lemma eq_bool_vc_rel:
  assumes "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1, ns\<rangle> \<Down> BoolV vc1" and "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e2, ns\<rangle> \<Down> BoolV vc2"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1 \<guillemotleft>Eq\<guillemotright> e2, ns\<rangle> \<Down> BoolV (vc1 = vc2)"
  using assms
  by (auto intro: RedBinOp)

lemma eq_int_vc_rel:
  assumes "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1, ns\<rangle> \<Down> IntV vc1" and "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e2, ns\<rangle> \<Down> IntV vc2"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1 \<guillemotleft>Eq\<guillemotright> e2, ns\<rangle> \<Down> BoolV (vc1 = vc2)"
  using assms
  by (auto intro: RedBinOp)

lemma eq_real_vc_rel:
  assumes "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1, ns\<rangle> \<Down> RealV vc1" and "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e2, ns\<rangle> \<Down> RealV vc2"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1 \<guillemotleft>Eq\<guillemotright> e2, ns\<rangle> \<Down> BoolV (vc1 = vc2)"
  using assms
  by (auto intro: RedBinOp)

lemma eq_abs_vc_rel:
  assumes "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1, ns\<rangle> \<Down> vc1" and "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e2, ns\<rangle> \<Down> vc2"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1 \<guillemotleft>Eq\<guillemotright> e2, ns\<rangle> \<Down> BoolV (vc1 = vc2)"
  using assms
  by (auto intro: RedBinOp)
...
lemma conj_vc_rel: 
  assumes "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1, ns\<rangle> \<Down> LitV (LBool vc1)" and "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e2, ns\<rangle> \<Down> LitV (LBool vc2)"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1 \<guillemotleft>And\<guillemotright> e2, ns\<rangle> \<Down> LitV (LBool (vc1 \<and> vc2))"
  using assms
  by (auto intro: RedBinOp)

lemma disj_vc_rel: 
  assumes "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1, ns\<rangle> \<Down> LitV (LBool vc1)" and "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e2, ns\<rangle> \<Down> LitV (LBool vc2)"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1 \<guillemotleft>Or\<guillemotright> e2, ns\<rangle> \<Down> LitV (LBool (vc1 \<or> vc2))"
  using assms
  by (auto intro: RedBinOp)

lemma imp_vc_rel: 
  assumes "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1, ns\<rangle> \<Down> LitV (LBool vc1)" and "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e2, ns\<rangle> \<Down> LitV (LBool vc2)"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1 \<guillemotleft>Imp\<guillemotright> e2, ns\<rangle> \<Down> LitV (LBool (vc1 \<longrightarrow> vc2))"
  using assms
  by (auto intro: RedBinOp)

lemma iff_vc_rel: 
  assumes "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1, ns\<rangle> \<Down> LitV (LBool vc1)" and "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e2, ns\<rangle> \<Down> LitV (LBool vc2)"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1 \<guillemotleft>Iff\<guillemotright> e2, ns\<rangle> \<Down> LitV (LBool (vc1 = vc2))"
  using assms
  by (auto intro: RedBinOp)

lemma not_vc_rel:
  assumes "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e, ns\<rangle> \<Down> LitV (LBool vc)"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>UnOp Not e, ns\<rangle> \<Down> LitV (LBool (\<not> vc))"
  using assms
...
lemma add_vc_rel: 
  assumes "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1, ns\<rangle> \<Down> LitV (LInt vc1)" and "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e2, ns\<rangle> \<Down> LitV (LInt vc2)"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1 \<guillemotleft>Add\<guillemotright> e2, ns\<rangle> \<Down> LitV (LInt (vc1 + vc2))"
  using assms
  by (auto intro: RedBinOp)

lemma sub_vc_rel: 
  assumes "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1, ns\<rangle> \<Down> LitV (LInt (vc1))" and "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e2, ns\<rangle> \<Down> LitV (LInt vc2)"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1 \<guillemotleft>Sub\<guillemotright> e2, ns\<rangle> \<Down> LitV (LInt (vc1 - vc2))"
  using assms
  by (auto intro: RedBinOp)

lemma mul_vc_rel: 
  assumes "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1, ns\<rangle> \<Down> LitV (LInt vc1)" and "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e2, ns\<rangle> \<Down> LitV (LInt vc2)"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1 \<guillemotleft>Mul\<guillemotright> e2, ns\<rangle> \<Down> LitV (LInt (vc1 * vc2))"
  using assms
  by (auto intro: RedBinOp)

lemma gt_vc_rel: 
  assumes "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1, ns\<rangle> \<Down> LitV (LInt vc1)" and "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e2, ns\<rangle> \<Down> LitV (LInt vc2)"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1 \<guillemotleft>Gt\<guillemotright> e2, ns\<rangle> \<Down> LitV (LBool (vc1 > vc2))"
  using assms
  by (auto intro: RedBinOp)

lemma ge_vc_rel: 
  assumes "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1, ns\<rangle> \<Down> LitV (LInt vc1)" and "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e2, ns\<rangle> \<Down> LitV (LInt vc2)"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1 \<guillemotleft>Ge\<guillemotright> e2, ns\<rangle> \<Down> LitV (LBool (vc1 \<ge> vc2))"
  using assms
  by (auto intro: RedBinOp)

lemma lt_vc_rel: 
  assumes "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1, ns\<rangle> \<Down> LitV (LInt vc1)" and "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e2, ns\<rangle> \<Down> LitV (LInt vc2)"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1 \<guillemotleft>Lt\<guillemotright> e2, ns\<rangle> \<Down> LitV (LBool (vc1 < vc2))"
  using assms
  by (auto intro: RedBinOp)

lemma le_vc_rel: 
  assumes "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1, ns\<rangle> \<Down> LitV (LInt vc1)" and "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e2, ns\<rangle> \<Down> LitV (LInt vc2)"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e1 \<guillemotleft>Le\<guillemotright> e2, ns\<rangle> \<Down> LitV (LBool (vc1 \<le> vc2))"
  using assms
  by (auto intro: RedBinOp)

lemma uminus_vc_rel:
  assumes "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e, ns\<rangle> \<Down> LitV (LInt vc)"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>UnOp UMinus e, ns\<rangle> \<Down> LitV (LInt (0 - vc))"
  using assms
  by (auto intro: RedUnOp)
...
lemma condexp_vc_rel:        
  assumes "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>cond, ns\<rangle> \<Down> BoolV vc_cond" and 
          "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>thn, ns\<rangle> \<Down> C vc_thn" and
          "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>els, ns\<rangle> \<Down> C vc_els"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>CondExp cond thn els, ns\<rangle> \<Down> C (ite_vc vc_cond vc_thn vc_els)"
  using assms
...
fun ty_to_closed :: "ty \<Rightarrow> closed_ty"
 ...
 |  "ty_to_closed (TMap tk tv) = TMapC (ty_to_closed tk) (ty_to_closed tv)"
...
fun closed_to_ty :: "closed_ty \<Rightarrow> ty"
 ...
 |  "closed_to_ty (TMapC tk tv) = TMap (closed_to_ty tk) (closed_to_ty tv)"
...
fun vc_type_of_val :: "('a::absval, 'm::mapval) val \<Rightarrow> closed_ty"
  where
   "vc_type_of_val v = ty_to_closed (type_of_val v)"
...
lemma vc_type_of_val_int: "vc_type_of_val (IntV i) = TPrimC TInt"
  by simp

lemma vc_type_of_val_real: "vc_type_of_val (RealV i) = TPrimC TReal"
  by simp

lemma vc_type_of_val_bool: "vc_type_of_val (IntV i) = TPrimC TInt"
  by simp
...
assumes "closed (instantiate \<Omega> ty)" and
        "closed (type_of_val v)" and
        "ty_to_closed (type_of_val v) = ty_to_closed (instantiate \<Omega> ty)"
shows "(type_of_val v) = (instantiate \<Omega> ty)"
...
lemma imp_vc:
assumes "vc0" and "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e, ns\<rangle> \<Down> BoolV vc"
shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e, ns\<rangle> \<Down> BoolV (vc0 \<longrightarrow> vc)"
using assms
  by simp
...
lemma conj_vc:
assumes "vc0" and "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e, ns\<rangle> \<Down> BoolV vc"
shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e, ns\<rangle> \<Down> BoolV (vc0 \<and> vc)"
using assms
  by simp
...
next
  ...
  have "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>Forall (TPrim primty) e, ns\<rangle> \<Down> LitV (LBool False)"
...
proof (cases "\<exists>i. P i")
  ...
  have "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>Exists (TPrim primty) e, ns\<rangle> \<Down> LitV (LBool True)"
...
lemma forall_vc_rel_int: 
  assumes "\<And> i. \<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e, full_ext_env ns (LitV (LInt i))\<rangle> \<Down> LitV (LBool (P i))"
  shows  "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>Forall (TPrim TInt) e, ns\<rangle> \<Down> LitV (LBool (\<forall>i. P i))"
  using assms
  by (rule forall_vc_rel_general, auto elim: type_of_val_int_elim)

lemma forall_vc_rel_bool: 
  assumes "\<And> b. \<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e, full_ext_env ns (LitV (LBool b))\<rangle> \<Down> LitV (LBool (P b))"
  shows  "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>Forall (TPrim TBool) e, ns\<rangle> \<Down> LitV (LBool (\<forall>b. P b))"
  using assms
  by (rule forall_vc_rel_general, auto elim: type_of_val_bool_elim)

lemma forall_vc_rel_real: 
  assumes "\<And> i. \<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e, full_ext_env ns (LitV (LReal i))\<rangle> \<Down> LitV (LBool (P i))"
  shows  "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>Forall (TPrim TReal) e, ns\<rangle> \<Down> LitV (LBool (\<forall>i. P i))"
  using assms
  by (rule forall_vc_rel_general, auto elim: type_of_val_real_elim)

lemma exists_vc_rel_int:
  assumes "\<And> i. \<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e, full_ext_env ns (LitV (LInt i))\<rangle> \<Down> LitV (LBool (P i))"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>Exists (TPrim TInt) e, ns\<rangle> \<Down> LitV (LBool (\<exists>i. P i))"
  using assms
  by (rule exists_vc_rel_general, auto elim: type_of_val_int_elim)

lemma exists_vc_rel_bool:
  assumes "\<And> b. \<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e, full_ext_env ns (LitV (LBool b))\<rangle> \<Down> LitV (LBool (P b))"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>Exists (TPrim TBool) e, ns\<rangle> \<Down> LitV (LBool (\<exists>b. P b))"
  using assms
  by (rule exists_vc_rel_general, auto elim: type_of_val_bool_elim)

lemma exists_vc_rel_real:
  assumes "\<And> i. \<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e, full_ext_env ns (LitV (LReal i))\<rangle> \<Down> LitV (LBool (P i))"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>Exists (TPrim TReal) e, ns\<rangle> \<Down> LitV (LBool (\<exists>i. P i))"
  using assms
...
lemma forall_vc_type:
  ...
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>Forall ty e, ns\<rangle> \<Down> LitV (LBool (\<forall>i. P i))"
proof (cases "\<forall>i. P i")
  case True
  then show ?thesis
    apply simp
...
next
  case False
  from this obtain z where "\<not>(P z)" by auto
  hence "vc_type_of_val z = ty_to_closed (instantiate \<Omega> ty)" using vcTypeFalse by auto
  hence zType:"type_of_val z  = instantiate \<Omega> ty" by (metis closedTypeOfVal closedInstTy closed_inv2 vc_type_of_val.simps)
  thus ?thesis
    apply (subst False)
...
lemma exists_vc_type:
  assumes closedTypeOfVal:"\<And> v. closed (type_of_val v)" and
   ...
   body: "\<And> i. type_of_val i = instantiate \<Omega> ty \<Longrightarrow> \<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>e, full_ext_env ns i\<rangle> \<Down> BoolV (P i)"
  shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>Exists ty e, ns\<rangle> \<Down> LitV (LBool (\<exists>i. P i))"
proof (cases "\<exists>i. P i")
  case True
  from this obtain z where "P z" by auto
  hence witnessType:"type_of_val z = instantiate \<Omega> ty" using vcTypeTrue
...
lemma forallt_vc:
assumes "\<And>\<tau>. closed \<tau> \<Longrightarrow> \<Lambda>,\<Gamma>,\<tau>#\<Omega> \<turnstile> \<langle>e,ns\<rangle> \<Down> BoolV (P (ty_to_closed \<tau>))"
shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>ForallT e, ns\<rangle> \<Down> BoolV (\<forall>t :: closed_ty. P t)"
...
next
  ...
  have "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>ForallT e,ns\<rangle> \<Down> BoolV False"
...
assumes "\<And>\<tau>. closed \<tau> \<Longrightarrow> \<Lambda>,\<Gamma>,\<tau>#\<Omega> \<turnstile> \<langle>e,ns\<rangle> \<Down> BoolV P"
shows "\<Lambda>,\<Gamma>,\<Omega> \<turnstile> \<langle>ForallT e, ns\<rangle> \<Down> BoolV P"
proof (cases P)
  case True
...
fun convert_val_to_int :: "('a, 'm) val \<Rightarrow> int"
  where "convert_val_to_int (LitV (LInt i)) = i"
  |  "convert_val_to_int _ = undefined"

fun convert_val_to_bool :: "('a, 'm) val \<Rightarrow> bool"
  where "convert_val_to_bool (LitV (LBool b)) = b"
  | "convert_val_to_bool _ = undefined"

fun convert_val_to_real :: "('a, 'm) val \<Rightarrow> real"
  where "convert_val_to_real (LitV (LReal r)) = r"
  |  "convert_val_to_real _ = undefined"

lemma tint_intv: "\<lbrakk> type_of_val v = TPrim TInt \<rbrakk> \<Longrightarrow> \<exists>i. v = LitV (LInt i)"
  by (auto elim: type_of_val_int_elim)

lemma tbool_boolv: "\<lbrakk> type_of_val v = TPrim TBool \<rbrakk> \<Longrightarrow> \<exists>b. v = LitV (LBool b)"
  by (auto elim: type_of_val_bool_elim)


lemma treal_realv: "\<lbrakk> type_of_val v = TPrim TReal \<rbrakk> \<Longrightarrow> \<exists>i. v = LitV (LReal i)"
...
lemma int_inverse_2:"\<forall> v. vc_type_of_val v = TPrimC TInt \<longrightarrow> IntV (convert_val_to_int v) = v"
...
lemma int_inverse_3:
"type_of_val v = TPrim TInt \<Longrightarrow> IntV (convert_val_to_int v) = v"
  using convert_val_to_int.simps(1) tint_intv by blast

lemma bool_inverse_1:"\<forall>b. convert_val_to_bool (BoolV b) = b"
  by simp

lemma bool_inverse_2:"\<forall> v. vc_type_of_val v = TPrimC TBool \<longrightarrow> BoolV (convert_val_to_bool v) = v"
proof (rule allI, rule impI)
  fix v
...
"type_of_val v = TPrim TBool \<Longrightarrow> BoolV (convert_val_to_bool v) = v"
  using bool_inverse_1 tbool_boolv by blast

lemma int_type:"\<forall>b. vc_type_of_val (IntV b) = TPrimC TInt"
  by simp

lemma bool_type:"\<forall>b. vc_type_of_val (BoolV b) = TPrimC TBool"
  by simp

lemma real_type:"\<forall>r. vc_type_of_val (RealV r) = TPrimC TReal"
  by simp

lemma real_inverse_1:"\<forall> r. convert_val_to_real (RealV r) = r"
  by simp

lemma real_inverse_2:"\<forall> v. vc_type_of_val v = TPrimC TReal \<longrightarrow> RealV (convert_val_to_real v) = v"
proof (rule allI, rule impI)
  fix v
  assume "vc_type_of_val v = TPrimC TReal"
...
"type_of_val v = TPrim TReal \<Longrightarrow> RealV (convert_val_to_real v) = v"
